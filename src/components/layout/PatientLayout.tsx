...
import AdvancedPatientPortal from '../hospital/AdvancedPatientPortal';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">MediCare Pro - Patient Portal</h1>
                <p className="text-sm text-gray-500">Welcome, {user?.name} - ID: {user?.patientId}</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs value={activeModule} onValueChange={handleModuleChange} className="w-full">
          <TabsList className="grid w-full grid-cols-2 mb-8">
            <TabsTrigger value="portal">My Health Portal</TabsTrigger>
            <TabsTrigger value="ai-assistant">Health Assistant</TabsTrigger>
          </TabsList>
